...
<body>
	<div class="page-wrap">
		...
		<section class="container-fluid profile">
			...
			<div class="row">
				<div class="col-xs-1">
					<img src="img/cara02.jpg" width="90" alt="">
				</div>
				<div class="col-xs-4">
					<p><b>Hernan Kisluk</b></br>
						Buenos Aires - Argentina</br>
						Portfolio Manager at Techint</br>
			...
			<div class="row margin-top">
					...
					<table class="table table-striped table-bordered ranking">
						<thead>
							<tr>
								...
								<th class="text-center"># of Forecasts</th>
							</tr>
						</thead>
						<tbody>
							<tr>
				...
				<div class="col-xs-6">
					<table class="table table-striped table-bordered ranking">
						<thead>
							<tr>
								<th>Leagues where Hernan participates</th>
							</tr>
						</thead>
						<tbody>
							<tr>
							...
							<tr>
								<td><img src="img/liga03.jpg" width="25" alt="" class="logo"> Forecast Brasil - Fundacao Getulio Vargas</td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div class="row articles mine">
				<div class="col-xs-12">
					<!-- article start -->
					<div class="row article">
						<div class="col-xs-6">
							<span>ISM surpised on the upside</span>
						</div>
